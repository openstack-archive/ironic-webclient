...
angular.module('ironic').controller('ProvisionActionModalController',
  function($q, $uibModalInstance, nodeIds, actionName, IronicNode, IronicNodeProvisionTransition,
     ...
     *
     * @returns {Promise} A promise that resolves with all valid states.
     */
     ...
     *
     * @returns {Promise} A promise that resolves with all nodes details.
     */
    function loadNodes () {
      var promises = [];
     ...
     * @returns {[]} That same list of loaded nodes, with no modifications.
     */
