...
/**
 * This resource handles node power transitions. It only exposes the $update (PUT) method,
 ...
 */
angular.module('ironic.api').factory('IronicNodePower',
  function($log, $$selectedConfiguration, $$resourceCache, $resource, $$dummyResource,
     ...
     *
     * @returns {{}} The created, and cached, IronicNodePower resource.
     */
    function getResource () {
      ...
      var nodeUrl = ironicApiRoot + '/nodes/:node_ident/states/power';

      if (!$$resourceCache.has(nodeUrl)) {
        $log.debug("Creating new IronicNodePower at: " + nodeUrl);
