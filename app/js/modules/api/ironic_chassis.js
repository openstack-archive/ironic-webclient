...
angular.module('ironic.api').factory('IronicChassis',
  function($$configuration, $$resourceCache, $resource, $log) {
    ...
    /**
     * Builds an ngResource instance that talks to the Ironic Chassis API.
     *
     * @param url Raw endpoint for the url.
     * @returns {*} An ng resource instance for the given url.
     */
    function buildResource (url) {
      $log.debug("Creating new IronicChassis at: " + url);
    ...
    function getResource () {
      ...
      var resourceUrl = new URL(baseUri + '/chassis/:uuid');
