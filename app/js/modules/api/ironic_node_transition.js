...
/**
 * IronicNodeTransition is a mock API that returns the transitions list for the ironic state
 * machine. It is intended to be replaced when the work for
 * https://review.openstack.org/#/c/224022/ lands.
 */
angular.module('ironic.api').factory('IronicNodeTransition',
  function($q) {
    ...
    // Add fake resource-like properties
    transitions.$promise = deferred.promise;
    transitions.$resolved = true;
