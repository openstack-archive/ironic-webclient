...
/**
 * Unit tests for Ironic's IronicNodePower resource.
 */
describe('IronicNodePower',
  function() {
    'use strict';
    ...
    describe('Interface', function() {
      it('should implement the update method',
        inject(function(IronicNodePower) {
          expect(IronicNodePower.update).toBeDefined();
        })
      );

      it('should not implement the query, create, read, or remove method',
        inject(function(IronicNodePower) {
          expect(IronicNodePower.query).not.toBeDefined();
          expect(IronicNodePower.create).not.toBeDefined();
          expect(IronicNodePower.read).not.toBeDefined();
          expect(IronicNodePower.remove).not.toBeDefined();
        })
      );
    });
    ...
    describe('basic behavior', function() {
      ...
      it('should switch API requests if the configuration changes.',
        inject(function(IronicNodePower, $$selectedConfiguration) {
          ...
          // Try a request
          $httpBackend.expectPUT('http://ironic.example.com:1000/nodes/test_id/states/power')
            .respond(202);
          var result1 = IronicNodePower.update(testManageBody);
          ...
          // Try a request
          $httpBackend.expectPUT('http://ironic.example.com:2000/nodes/test_id/states/power')
            .respond(202);
          var result2 = IronicNodePower.update(testManageBody);
          ...
          $httpBackend.expectPUT('http://ironic.example.com:1000/nodes/test_id/states/power')
            .respond(202);
          var result3 = IronicNodePower.update(testManageBody);
      ...
      it('should return a failed resource if an invalid config has been selected',
        inject(function(IronicNodePower) {
          var updateResult = IronicNodePower.update(testManageBody);
      ...
      it('should correctly parse error responses',
        inject(function(IronicNodePower, $$selectedConfiguration) {
          ...
          var result = IronicNodePower.update(testManageBody);
